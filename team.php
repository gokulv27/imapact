        ...
        <div class="row gx-0">
            <div class="col-lg-3 bg-dark d-none d-lg-block">
                <a href="index.html" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                    <h1 class="m-0 display-4 text-primary text-uppercase" colspan="6">Impact Fitness<br colspan="3">Gym</h1>
                </a>
            </div>
            <div class="col-lg-9">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5">
                    <a href="index.html" class="navbar-brand d-block d-lg-none">
                         <h6 class="m-0 display-4 text-primary text">Impact Fitness</h6>
                    </a>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0"><a href="https://goo.gl/maps/nipgVoNX61qHwEhbA">Bus Stop, No 19,Sambanki Street,Peerkankaranai Erikarai, Irumbuliyur, Chennai, Tamil Nadu 600063</a></p>
                        </div>
                        <div class="d-flex mb-2">
        ...
        <div class="row gx-5">
            <div class="col-lg-8">
                <div class="py-lg-4 text-center">
                    <p class="text-secondary mb-0">&copy; <a class="text-light fw-bold" href="#">Impact fitness gym</a>. All Rights Reserved.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="py-lg-4 text-center credit">
                    <p class="text-light mb-0">Designed by <a class="text-light">Gokul</a></p>
                </div>
            </div>
        </div>
    </div>
